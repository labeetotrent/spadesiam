    ...
    <nav class="navbar navbar-default " role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Spa De Siam</a>
            </div>
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12 text-center">
                    ...
                    <h1 class="brand-name">Spa De Siam</h1>
                    <hr class="tagline-divider">
                    <h2>
                      <small>
                            <strong>Authentic Thai Massage and Spa</strong>
                      </small>
                    </h2>
                </div>
            </div>
...
separate room for body treatment has been designed to enable you to enjoy the most
...
of Asian bodywork therapy that is based on the treatment of the human body, mind,

and spirit. The therapy includes treating the electromagnetic or energetic field that

surrounds, infuses and brings the body to life through pressure and/or manipulative

massage.</p>

<p>The benefits of traditional Thai massage:
<ul>
<li>Increases flexibility and range of movement</li>
<li>Eliminates muscle pain and muscle spasms</li>
<li>Improves postural alignment</li>
<li>Calms the nervous system and promotes a deep sense of relaxation</li>
<li>Increased energy level</li>
<li>Allows for a significant release of deep, emotional distress</li>
<li>Stimulates blood circulation and lymph drainage</li>
<li>Stimulates internal organs</li>
<li>Relieves fatigue, swollen limbs, painful joints, and headaches</li>
</ul></p>
<h3>Visit us on <a href="https://www.facebook.com/spadesiambrisbane"><i class="fa fa-facebook-square"></i></a> for our latest special deals!</h3>
...
<section id="location">
  <div class="row">
      <div class="box" id="location">
          ...
          <div class="col-md-4">
              <p>Phone:
                  <strong><a href="tel:0731582296">07 3158 2296</a></strong>
              </p>
              <p>Mobile:
                  <strong><a href="tel:0424785277">0424 785 277</a></strong>
              </p>
              <p>Line ID:
  ...
  <div class="row">
      <div class="box">
          <div class="col-lg-12">
              ...
              <p>Our current trading hours are Monday - Sunday, 10am - 8pm</p>
  ...
  <div class="modal-dialog">
    ...
    <footer>
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <p>Copyright &copy; Spa De Siam 2015<br>Website Designed by <a href="www.trentit.com.au">TrentIT</a></p>
                </div>
            </div>
        </div>
    </footer>
